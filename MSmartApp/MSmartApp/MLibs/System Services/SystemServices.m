...
//#warning 题主呕心沥血总结！！最全面！亲测！全网独此一份！！
    ...
    if ([deviceString isEqualToString:@"iPhone3,1"])    return @"iPhone3,1";
    
    if ([deviceString isEqualToString:@"iPhone3,2"])    return @"iPhone3,2";
    
    if ([deviceString isEqualToString:@"iPhone3,3"])    return @"iPhone3,3";
    
    if ([deviceString isEqualToString:@"iPhone4,1"])    return @"iPhone4,1";
    
    if ([deviceString isEqualToString:@"iPhone5,1"])    return @"iPhone5,1";
    
    if ([deviceString isEqualToString:@"iPhone5,2"])    return @"iPhone5,2";
    
    if ([deviceString isEqualToString:@"iPhone5,3"])    return @"iPhone5,3";
    
    if ([deviceString isEqualToString:@"iPhone5,4"])    return @"iPhone5,4";
    
    if ([deviceString isEqualToString:@"iPhone6,1"])    return @"iPhone6,1";
    
    if ([deviceString isEqualToString:@"iPhone6,2"])    return @"iPhone6,2";
    
    if ([deviceString isEqualToString:@"iPhone7,1"])    return @"iPhone7,1";
    
    if ([deviceString isEqualToString:@"iPhone7,2"])    return @"iPhone7,2";
    
    if ([deviceString isEqualToString:@"iPhone8,1"])    return @"iPhone8,1";
    
    if ([deviceString isEqualToString:@"iPhone8,2"])    return @"iPhone8,2";
    
    if ([deviceString isEqualToString:@"iPhone8,4"])    return @"iPhone8,4";
    
    
    
    if ([deviceString isEqualToString:@"iPod1,1"])      return @"iPod1,1";
    
    if ([deviceString isEqualToString:@"iPod2,1"])      return @"iPod2,1";
    
    if ([deviceString isEqualToString:@"iPod3,1"])      return @"iPod3,1";
    
    if ([deviceString isEqualToString:@"iPod4,1"])      return @"iPod4,1";
    
    if ([deviceString isEqualToString:@"iPod5,1"])      return @"iPod5,1";
    
    
    
    if ([deviceString isEqualToString:@"iPad1,1"])      return @"iPad1,1";
    
    if ([deviceString isEqualToString:@"iPad1,2"])      return @"iPad1,2";
    
    if ([deviceString isEqualToString:@"iPad2,1"])      return @"iPad2,1";
    
    if ([deviceString isEqualToString:@"iPad2,2"])      return @"iPad2,2";
    
    if ([deviceString isEqualToString:@"iPad2,3"])      return @"iPad2,3";
    
    if ([deviceString isEqualToString:@"iPad2,4"])      return @"iPad2,4";
    
    if ([deviceString isEqualToString:@"iPad2,5"])      return @"iPad2,5";
    
    if ([deviceString isEqualToString:@"iPad2,6"])      return @"iPad2,6";
    
    if ([deviceString isEqualToString:@"iPad2,7"])      return @"iPad2,7";
    
    if ([deviceString isEqualToString:@"iPad3,1"])      return @"iPad3,1";
    
    if ([deviceString isEqualToString:@"iPad3,2"])      return @"iPad3,2";
    
    if ([deviceString isEqualToString:@"iPad3,3"])      return @"iPad3,3";
    
    if ([deviceString isEqualToString:@"iPad3,4"])      return @"iPad3,4";
    
    if ([deviceString isEqualToString:@"iPad3,5"])      return @"iPad3,5";
    
    if ([deviceString isEqualToString:@"iPad3,6"])      return @"iPad3,6";
    
    if ([deviceString isEqualToString:@"iPad4,1"])      return @"iPad4,1";
    
    if ([deviceString isEqualToString:@"iPad4,2"])      return @"iPad4,2";
    
    if ([deviceString isEqualToString:@"iPad4,4"])      return @"iPad4,4";
    
    if ([deviceString isEqualToString:@"iPad4,5"])      return @"iPad4,5";
    
    if ([deviceString isEqualToString:@"iPad4,6"])      return @"iPad4,6";
    
    if ([deviceString isEqualToString:@"iPad4,7"])      return @"iPad4,7";
    
    if ([deviceString isEqualToString:@"iPad4,8"])      return @"iPad4,8";
    
    if ([deviceString isEqualToString:@"iPad4,9"])      return @"iPad4,9";
    
    if ([deviceString isEqualToString:@"iPad5,1"])      return @"iPad5,1";
    
    if ([deviceString isEqualToString:@"iPad5,2"])      return @"iPad5,2";
    
    if ([deviceString isEqualToString:@"iPad5,3"])      return @"iPad5,3";
    
    if ([deviceString isEqualToString:@"iPad5,4"])      return @"iPad5,4";
    
    if ([deviceString isEqualToString:@"iPad6,3"])      return @"iPad6,3";
    
    if ([deviceString isEqualToString:@"iPad6,4"])      return @"iPad6,4";
    
    if ([deviceString isEqualToString:@"iPad6,7"])      return @"iPad6,7";
    
    if ([deviceString isEqualToString:@"iPad6,8"])      return @"iPad6,8";
    
    
    if ([deviceString isEqualToString:@"i386"])         return @"i386";
    
    if ([deviceString isEqualToString:@"x86_64"])       return @"x86_64";
